...
#define LIST_IMAGES \
	...
	IMG_DO(FLAT_DEPTH,                21, R16_SFLOAT,          r32f,    IMG_WIDTH,           IMG_HEIGHT     ) \
	...
	IMG_DO(CLEAR,                     38, R8G8B8A8_UNORM,      rgba8,   1,                   1              ) \
	IMG_DO(NRD_NORMAL_ROUGHNESS,      39, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_DIFF_RADIANCE_HITDIST, 40, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_SPEC_RADIANCE_HITDIST, 41, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_DIFF_CONFIDENCE,       42, R8_UNORM,            r8,      IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_SPEC_CONFIDENCE,       43, R8_UNORM,            r8,      IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_DISOCCLUSION_MIX,      44, R8_UNORM,            r8,      IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_VIEWZ,                 45, R16_SFLOAT,          r32f,    IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_MV,                    46, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
	IMG_DO(NRD_OUT_DIFF_RADIANCE_HITDIST, 47, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,  IMG_HEIGHT     ) \
	IMG_DO(NRD_OUT_SPEC_RADIANCE_HITDIST, 48, R16G16B16A16_SFLOAT, rgba16f, IMG_WIDTH_MGPU,  IMG_HEIGHT     ) \

#define NUM_IMAGES_BASE     49
...
#define LIST_IMAGES_A_B \
	...
	IMG_DO(RESTIR_RESERVOIR_A,         NUM_IMAGES_BASE + 30, R32G32B32A32_UINT,   rgba32ui, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
...
#define LIST_IMAGES_B_A \
	...
	IMG_DO(RESTIR_RESERVOIR_B,         NUM_IMAGES_BASE + 30, R32G32B32A32_UINT,   rgba32ui, IMG_WIDTH_MGPU,      IMG_HEIGHT     ) \
